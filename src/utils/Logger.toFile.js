...
console.log('INFO : Logger.js > DocumentDirectoryPath:', DocumentDirectoryPath);
console.log('INFO : Logger.js > ExternalDirectoryPath:', ExternalDirectoryPath);
console.log(
  'INFO : Logger.js > ExternalStorageDirectoryPath:',
  ExternalStorageDirectoryPath,
);
console.log('INFO : Logger.js > CachesDirectoryPath:', CachesDirectoryPath);
console.log('INFO : Logger.js > LibraryDirectoryPath:', LibraryDirectoryPath);
