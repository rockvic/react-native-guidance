...
import MarkDown from 'react-native-md';
...
const Tutorial: FC<Props> = () => {
  ...
  function loadMd() {
    ...
    const example = require('../examples/md/example.md');
    loadLocalResource(example).then((content: any) => {
  ...
  return (
    <ScrollView style={styles.rootSv}>
      <View style={[styles.root, { marginBottom: bottomTabBarHeight }]}>
        ...
        <MarkDown style={{ body:{ marginTop: 20 } }}>
          {md}
        </MarkDown>
      </View>
    </ScrollView>
